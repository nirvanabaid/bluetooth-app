        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
                ...
                child: Text("Data Received", style: TextStyle(fontSize: height*0.025, fontWeight: FontWeight.w500, color: Colors.white),)),
            Container(
              ...
              margin: EdgeInsets.symmetric(horizontal: width*0.055, vertical: height*0.005),
              padding: EdgeInsets.symmetric(vertical: height*0.015, horizontal: width*0.05),
              child: Text(finalReadData, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 17),),
            ),
            SizedBox(height: height*0.02,),
            Padding(
                padding: EdgeInsets.symmetric(horizontal: 20),
  ...
  void _onDataReceived(Uint8List data) {
    ...
    if (~index != 0) {
      setState(() {
        ...
        finalReadData=backspacesCounter > 0
            ? _messageBuffer.substring(
            0, _messageBuffer.length - backspacesCounter)
            : _messageBuffer + dataString.substring(0, index);
